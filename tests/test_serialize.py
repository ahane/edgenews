...
def test_deserialize_empty_new_user(empty_new_user_jsonapi, empty_new_user_response):
...
def test_deserialize_currupt_new_user(corrupt_new_user_jsonapi, corrupt_new_user_response):
    with pytest.raises(serialize.ValidationError) as err:
